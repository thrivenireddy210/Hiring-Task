...
const KeyValue: React.FC<{
  ...
  console.log("ddddfffjdjjdjdj",value)
  return (
    <Box w="100%">
...
const PreviewCard: React.FC<{
  ...
  console.log("dfghjklkjhg",formData);
  return (
    <Box p="1rem">
          ...
          >
            ...
            >
              <Text fontSize="0.9rem" fontWeight="500">
                {formData.requisitionDetails.requisitionTitle}
              </Text>
              <Flex justifyContent="space-around" alignItems="center">
                ...
                <Text fontSize="1rem" fontWeight="bold" as="span">
                  {formData.requisitionDetails.noOfOpenings}
                </Text>
              </Flex>
            </Flex>
          </Box>
        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          <DataCard title="Requisition Details">
            <KeyValue
              ...
              value={
                urgencyOptions.find(
                  (item) => item?.value === formData.requisitionDetails.urgency
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                genderOptions.find(
                  (item) => item?.value === formData.requisitionDetails.gender
                )?.label
              }
            />
          </DataCard>
          <DataCard title="Job Detail">
            <KeyValue title="Job Title" value={formData.jobDetails?.jobTitle} />
            <KeyValue title="Job Details" value={formData.jobDetails?.jobDetails} />
            <KeyValue title="Job Location" value={formData.jobDetails?.jobLocation} />
          </DataCard>
            ...
            <KeyValue
              ...
              value={
                interviewDurationOptions.find(
                  (item) => item?.value === formData.interviewSettings?.interviewDuration
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewLanguageOptions.find(
                  (item) => item?.value === formData.interviewSettings?.interviewLanguage
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewModeOptions.find(
                  (item) => item?.value === formData.interviewSettings?.interviewMode
                )?.label
              }
            />
          </DataCard>
